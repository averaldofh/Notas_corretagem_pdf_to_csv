...
Lista_empresas = pd.read_excel(r'D:\Python\Notas\Empresas_Listadas.xls')
...
def pdf_to_pandas_clear(path):
    ...
    for i in notas_path:
        ...
        #Fixing the columns
        notas_de_corretagem2.columns = ['C/V', 'Tipo de Mercado',
                                        'Especificação do título','TICKER', 'Quantidade', 'Preço','Valor', 'Débito/Crédito']
...
path = r'D:\Python\Notas'
notas = pdf_to_pandas_clear(path)


# notas.to_excel(r'D:\Python\Notas-de-Corretagem-Clear-pdf-to-pandas-main\notas.xlsx')
